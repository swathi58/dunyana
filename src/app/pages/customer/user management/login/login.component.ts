...
export class LoginComponent implements OnInit {
  ...
  OnLogin() {
    ...
    this.dataservice.login(this.userPostData).subscribe(res => {
      ...
      this.show = false;
      this.div.nativeElement.innerHTML = "Your mail is inactive state..";
    }
  
    else if(res['loginStatus']==2){
      this.show = false;
      this.div.nativeElement.innerHTML = "Your mail is blocked";
    }
    else if(res['loginStatus']==3){
      this.show = false;
      this.div.nativeElement.innerHTML = "Your mail is barred state";
    }
      this.Resetlog();
